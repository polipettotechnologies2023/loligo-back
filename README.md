...
```
cd existing_repo
git remote add origin https://gitlab.hrz.tu-chemnitz.de/vsr/edu/planspiel/WS2324/polipetto-technologies.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.hrz.tu-chemnitz.de/vsr/edu/planspiel/WS2324/polipetto-technologies/-/settings/integrations)
